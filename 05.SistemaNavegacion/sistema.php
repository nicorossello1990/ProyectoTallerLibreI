         ...
         <td width="900">
                <div id='fotos'>
                  ...
                  function ejecutarPython($archivoPython, $consulta){
                      ...
                      if ($cantidad == 0) {
                        echo "<tr> <td> No se encontraron imágenes en la etiqueta $consulta "; }
                      else{
                          echo "<tr> <td>Etiqueta: $consulta. Total de Imagenes: $cantidad </td> </tr> <tr> <td> "; 
                          for ($i=0; $i<$cantidad;$i++){ 
                             echo "<a href = 'sistema2.php?etiqueta=$consulta&imagen=$imagenes[$i]'>  <img src='Fotos/$imagenes[$i].jpg' alt='Smiley face' hspace='20'> </a> "; 
                             }
                          }              
                      echo     " </td></tr></table>"; 
