...
#Programa que recupera las imagenes relevantes a una o varias etiquetas de consulta textual pasada por argumentos. Devuelve una lista Rankeada con los ID de las imagenes relevantes de la consulta dada.

#Funcion que carga el Indice etiqueta-etiquetaRelacionadas.
def cargarRelacionados():
   archivo = open ('postingEtiquetasRelacionadas_or.txt','r')
   hashRelacionados= {}
...
def cargarImagenes():
   archivo = open ('postingImagenes_or.txt','r')
   hashImagenes= {}
   for linea in archivo:     
...
def cargarEtiquetas():
   archivo = open ('postingEtiquetas_or.txt','r')
   hashEtiquetas = {}
   for linea in archivo: 
